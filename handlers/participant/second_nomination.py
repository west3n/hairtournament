...
def register(dp: Dispatcher):
    dp.register_message_handler(handle_first_photo, content_types=['photo'], state=Nomination_second.first_photo)
    dp.register_callback_query_handler(change_media_first, state=Nomination_second.first_photo)
    dp.register_message_handler(handle_second_photo, content_types=['photo'], state=Nomination_second.second_photo)
    dp.register_callback_query_handler(change_media_second, state=Nomination_second.second_photo)
    dp.register_message_handler(handle_first_video, content_types=['video'], state=Nomination_second.first_video)
    dp.register_callback_query_handler(change_media_third, state=Nomination_second.first_video)
    dp.register_message_handler(handle_second_video, content_types=['video'], state=Nomination_second.second_video)
    dp.register_callback_query_handler(change_media_fourth, state=Nomination_second.second_video)
    dp.register_message_handler(handle_third_video, content_types=['video'], state=Nomination_second.third_video)
    dp.register_callback_query_handler(change_media_fifth, state=Nomination_second.third_video)
    dp.register_message_handler(handle_third_photo, content_types=['photo'], state=Nomination_second.third_photo)
    dp.register_callback_query_handler(change_media_sixth, state=Nomination_second.third_photo)
    dp.register_message_handler(handle_fourth_video, content_types=['video'], state=Nomination_second.fourth_video)
    dp.register_callback_query_handler(change_media_seventh, state=Nomination_second.fourth_video)
    dp.register_message_handler(handle_fourth_photo, content_types=['photo'], state=Nomination_second.fourth_photo)
    dp.register_callback_query_handler(change_media_eight, state=Nomination_second.fourth_photo)
    dp.register_message_handler(handle_fifth_video, content_types=['video'], state=Nomination_second.fifth_video)
    dp.register_callback_query_handler(change_media_ninth, state=Nomination_second.fifth_video)
    dp.register_message_handler(handle_fifth_photo, content_types=['photo'], state=Nomination_second.fifth_photo)
    dp.register_callback_query_handler(change_media_tenth, state=Nomination_second.fifth_photo)
    dp.register_message_handler(handle_sixth_photo, content_types=['photo'], state=Nomination_second.sixth_photo)
    dp.register_callback_query_handler(change_media_eleventh, state=Nomination_second.sixth_photo)
    dp.register_message_handler(handle_sixth_video, content_types=['video'], state=Nomination_second.sixth_video)
    dp.register_callback_query_handler(change_media_twelfth, state=Nomination_second.sixth_video)
    dp.register_message_handler(handle_seventh_video, content_types=['video'], state=Nomination_second.seventh_video)
    dp.register_callback_query_handler(change_media_thirteenth, state=Nomination_second.seventh_video)
    dp.register_message_handler(handle_eighth_video, content_types=['video'], state=Nomination_second.eighth_video)
    dp.register_callback_query_handler(change_media_fourteenth, state=Nomination_second.eighth_video)
    dp.register_message_handler(handle_ninth_video, content_types=['video'], state=Nomination_second.ninth_video)
    dp.register_callback_query_handler(change_media_fifteenth, state=Nomination_second.ninth_video)
    dp.register_message_handler(handle_seventh_photo, content_types=['photo'], state=Nomination_second.seventh_photo)
    dp.register_callback_query_handler(change_media_sixteenth, state=Nomination_second.seventh_photo)
    dp.register_message_handler(handle_eighth_photo, content_types=['photo'], state=Nomination_second.eighth_photo)
